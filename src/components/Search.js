...
export const Search = ({ onUpdate }) => {
  ...
  return (
    <StyledSearch
      data-js={query ? 'has-searched' : 'has-not-searched'}
      className="search-form"
      onSubmit={onHandleSubmitSearch}
    >
      <button
        name="clear"
...
const StyledSearch = styled.form`
  ...
  z-index: 500; // Search
  transition: width 0.3s ease, top 0.5s ease-in-out;
  ...
  &[data-js="has-not-searched"]{
    top: calc(50% - 5rem); // Centered
  }
